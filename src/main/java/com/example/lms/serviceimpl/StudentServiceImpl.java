...
//	// Create a new LibraryCard entity and set its properties
	...
	@Override
	public StudentResponseDto updateEmail(StudentRequestDto studentUpdateEmailRequestDto) {
	    ...
	    if (optionalStudent.isPresent()) {
	        ...
	        // Create a new StudentDto to return the updated student information
	        StudentResponseDto studentResponseDto = new StudentResponseDto();
	        studentResponseDto.setSId(updatedStudent.getSId()); // Set the ID of the updated student
	        studentResponseDto.setSname(updatedStudent.getSname()); // Set the name of the updated student
	        studentResponseDto.setEmail(updatedStudent.getEmail()); // Set the updated email
