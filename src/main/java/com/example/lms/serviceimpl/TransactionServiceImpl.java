...
//		LibraryCard libraryCard = cardRepository.findById(issueBookRequestDto.getCardId()).orElseThrow(() -> {
//			transaction.setTransactionStatus(TransactionStatus.FAILED);
//			transaction.setMessage("Card not found");
//			transactionRepository.save(transaction);
//			return new CardNotPresentException("Card not present");
//		});
//
//		// Fetch the book
//		Book book = bookRepository.findById(issueBookRequestDto.getBookId()).orElseThrow(() -> {
//			transaction.setTransactionStatus(TransactionStatus.FAILED);
